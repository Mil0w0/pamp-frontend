...
export const GradingGridForm: React.FC<GradingGridFormProps> = ({
    projectId,
    gridId,
    type,
    targetId,
    ...
    const fetchStudents = async () => {
        ...
        try {
            ...
            if (response.success) {
                ...
                if (currentProject?.studentBatch?.students) {
    ...
    }, [formData.notationMode, projectId, currentProject])
    ...
    const handleSave = async () => {
        try {
            if (grid) {
                ...
                if (!newGrid || error) {
                    alert(
                        'An errorr occured while saving the grid: ' +
            ...
            alert(
                'An error occured while saving the grid: ' +
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center justify-between">
                        <span>
                            {grid ? 'Edit Grading Grid' : 'Create Grading Grid'}
                        </span>
                        {grid?.isValidated && (
                            <Badge
                                variant="secondary"
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="notationMode">Grading Mode</Label>
                            <Select
                    ...
                    {!grid && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Select
                                    value={formData.type}
                                    onValueChange={(value: GradingGridType) =>
                                        setFormData((prev) => ({
                                            ...prev,
                                            type: value,
                                        }))
                        ...
                        <div className="p-4 bg-muted rounded-lg">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <div className="font-medium">
                                        {formatPercentage(stats.weightedScore)}
                                    </div>
                                </div>
                                <div>
                                    <span className="text-muted-foreground">
                    ...
                    {!readOnly && !grid?.isValidated && (
                        <div className="flex flex-col md:flex-row items-center gap-2 pt-4 border-t w-full">
                            ...
                            <div className="flex flex-col items-center gap-1">
                                <Label htmlFor="commentEnabled">Comment</Label>
                                <Switch
                                    id="commentEnabled"
